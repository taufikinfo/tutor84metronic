...
class KEntry extends TEntry
{
    public function show()
    {
        // Define the outer div
        $div = new TElement('div');
        $div->{'wrapped-widget'} = 'tentry';

        // Set the class and other attributes for the input tag
        $this->tag->{'class'} = 'form-control form-control-lg form-control-solid';
