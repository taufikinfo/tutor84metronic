...
class PrivateChat
{
    ...
    function get_all_chat_data()
    {
		...
		WHERE (chat_message.from_user_id = ? AND chat_message.to_user_id = ? ) 
		OR (chat_message.from_user_id = ? AND chat_message.to_user_id = ?)
		";

        $statement = $this->connect->prepare($query);
        $statement->execute([$this->from_user_id, $this->to_user_id, $this->from_user_id, $this->to_user_id]);
    ...
    function save_chat()
    {
        ...
        $statement = $this->connect->prepare($query);
        $statement->execute([$this->to_user_id, $this->from_user_id, $this->chat_message, $this->timestamp, $this->status]);
