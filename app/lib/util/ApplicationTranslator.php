...
class ApplicationTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['en'][] = 'Designed shapes';
        $this->messages['en'][] = 'Designed report';
        $this->messages['en'][] = 'Designed Danfe';
        ...
        $this->messages['en'][] = 'Curtain filters';
        $this->messages['en'][] = 'Window filters';
        $this->messages['en'][] = 'Standard Form/DataGrid with curtain';
        $this->messages['en'][] = 'Standard Form/DataGrid with window';
        $this->messages['en'][] = 'Simple calendar';
        $this->messages['en'][] = 'Manual agenda';
        $this->messages['en'][] = 'Gantt with data';
        $this->messages['en'][] = 'Dynamic criteria with session variable';
        $this->messages['en'][] = 'Datagrid SQL query';
        $this->messages['en'][] = 'Datagrid Rest query';
        $this->messages['en'][] = 'Strongly disagree';
        $this->messages['en'][] = 'Disagree';
        $this->messages['en'][] = 'Neutral';
        $this->messages['en'][] = 'Agree';
        $this->messages['en'][] = 'Strongly agree';
        $this->messages['en'][] = 'Likert scale';
        $this->messages['en'][] = 'Low level DDL commands';
        $this->messages['en'][] = 'Low level DML commands';
        $this->messages['en'][] = 'Copy button';
        $this->messages['en'][] = 'Extension not found: ^1';
        $this->messages['en'][] = 'Dark mode';
        $this->messages['en'][] = 'Modal form';
        $this->messages['en'][] = 'Collections with subquery';
        $this->messages['en'][] = 'Readonly transactions';
        ...
        $this->messages['pt'][] = 'Desenho com formas';
        $this->messages['pt'][] = 'Desenho com relatório';
        $this->messages['pt'][] = 'Desenho de Danfe';
        ...
        $this->messages['pt'][] = 'Filtros em cortina';
        $this->messages['pt'][] = 'Filtros em janela';
        $this->messages['pt'][] = 'Form/Datagrid padronizada com cortina';
        $this->messages['pt'][] = 'Form/Datagrid padronizada com janela';
        $this->messages['pt'][] = 'Calendário simples';
        $this->messages['pt'][] = 'Agenda manual';
        $this->messages['pt'][] = 'Gantt com dados';
        $this->messages['pt'][] = 'Critério dinâmico com variável de sessão';
        $this->messages['pt'][] = 'Datagrid consulta SQL';
        $this->messages['pt'][] = 'Datagrid consulta Rest';
        $this->messages['pt'][] = 'Discordo plenamente';
        $this->messages['pt'][] = 'Discordo';
        $this->messages['pt'][] = 'Neutro';
        $this->messages['pt'][] = 'Concordo';
        $this->messages['pt'][] = 'Concordo plenamente';
        $this->messages['pt'][] = 'Escala likert';
        $this->messages['pt'][] = 'Comandos DDL baixo nível';
        $this->messages['pt'][] = 'Comandos DML baixo nível';
        $this->messages['pt'][] = 'Botão de copiar';
        $this->messages['pt'][] = 'Extensão não encontrada: ^1';
        $this->messages['pt'][] = 'Modo escuro';
        $this->messages['pt'][] = 'Formulário modal';
        $this->messages['pt'][] = 'Coleções com subquery';
        $this->messages['pt'][] = 'Transações somente leitura';
