...
class ContainerNotebookView extends TPage
{
    ...
    function __construct()
    {
        ...
        $notebook->appendPage('<i data-lucide="database" class="me-2"></i> Basic data', $page1);
        $notebook->appendPage('<i data-lucide="layout-panel-left" class="me-2"></i> Other data', $page2);
        $notebook->appendPage('<i data-lucide="sticky-note" class="me-2"></i> Other note', $page3);
        ...
        $subnotebook->appendPage('<i data-lucide="file-plus" class="me-2"></i> new page1', new TLabel('test1'));
        $subnotebook->appendPage('<i data-lucide="file-text" class="me-2"></i> new page2', new TText('test2'));
