...
class ProductForm extends TPage
{
    ...
    function __construct()
    {
        ...
        // add the form fields
        $this->form->addFields( [new TLabel('ID', 'var(--bs-red)')],          [$id] );
        $this->form->addFields( [new TLabel('Description', 'var(--bs-red)')], [$description] );
        $this->form->addFields( [new TLabel('Stock', 'var(--bs-red)')],       [$stock],
                                [new TLabel('Sale Price', 'var(--bs-red)')],  [$sale_price] );
        $this->form->addFields( [new TLabel('Unity', 'var(--bs-red)')],       [$unity] );
